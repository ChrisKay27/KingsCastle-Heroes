...
import com.kingscastle.effects.animations.DestroyedBuildingAnim;
...
public abstract class Building extends LivingThing
{
	...
	//Needs to stay final, Assumed its not null
	...
	static{
		addPackageToFindBuildings("com.kingscastle.gameElements.livingThings.buildings.");
	}
