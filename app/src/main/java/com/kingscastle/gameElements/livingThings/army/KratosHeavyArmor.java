...
public class KratosHeavyArmor extends MeleeSoldier
{
	...
	static
	{
		...
		STATIC_ATTRIBUTES.setHealth( 800 ); STATIC_ATTRIBUTES.setdHealthAge( 0 ); STATIC_ATTRIBUTES.setdHealthLvl( 10 ); //
		STATIC_ATTRIBUTES.setFullMana( 0 );
		STATIC_ATTRIBUTES.setMana( 0 );
		STATIC_ATTRIBUTES.setHpRegenAmount( 1 );
		STATIC_ATTRIBUTES.setRegenRate( 1000 );
		STATIC_ATTRIBUTES.setArmor( 20 );  STATIC_ATTRIBUTES.setdArmorAge( 3 ); STATIC_ATTRIBUTES.setdArmorLvl( 1 );
		STATIC_ATTRIBUTES.setSpeed( .9f * dp );
	}
	...
	public KratosHeavyArmor(@NonNull vector loc, Teams team)
	{
		super(team);
		setLoc( loc );
		super.team = team;
