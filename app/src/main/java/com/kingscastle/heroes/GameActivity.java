...
//                .build();
        ...
        String levelClassName = HeroesForestLevel.class.getSimpleName();
        if (extras != null)
            levelClassName = extras.getString(Strings.LevelClassName, HeroesForestLevel.class.getSimpleName());
        ...
        setContentView(com.kingscastle.heroes.R.layout.activity_game);

        if (tdg == null)
            tdg = new Game(this, (AndroidFastRenderView) findViewById(com.kingscastle.heroes.R.id.surfaceView), levelClassName, diff);

        tdg.onCreate(this, (AndroidFastRenderView) findViewById(com.kingscastle.heroes.R.id.surfaceView));
