...
public class StatueGoldScepter extends Building {
	...
	static{
		STATIC_ATTRIBUTES = new Attributes(); STATIC_ATTRIBUTES.setRequiresAge(Age.STONE); STATIC_ATTRIBUTES.setRequiresTcLvl(12);
	...
	public StatueGoldScepter(@NonNull vector v, Teams t)
	{
		super(name );
