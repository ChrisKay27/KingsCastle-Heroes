...
public class StatueDragon extends Building {
	...
	static{
		STATIC_ATTRIBUTES = new Attributes(); STATIC_ATTRIBUTES.setRequiresAge(Age.STONE); STATIC_ATTRIBUTES.setRequiresTcLvl(8);
	...
	public StatueDragon(@NonNull vector v, Teams t)
	{
		super(name );
