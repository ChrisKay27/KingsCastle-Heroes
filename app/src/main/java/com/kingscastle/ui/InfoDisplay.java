...
import com.kingscastle.gameElements.livingThings.SoldierTypes.BasicMageSoldier;
...
import com.kingscastle.gameElements.livingThings.SoldierTypes.MediumHealer;
...
import com.kingscastle.gameElements.livingThings.SoldierTypes.UpperHealer;
	...
	public void showInfoDisplay(  final LivingThing st, final Team team_ , final OnClickListener closeListener ){
		...
		a.runOnUiThread( new Runnable(){
			...
			public void run() {
				...
				id = new ImageDrawable( (st.getAnim().getImage().getBitmap()) , 0 , 0 , 1f , 1f , new Paint() );
