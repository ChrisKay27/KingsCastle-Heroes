...
public class ExoticRings extends MeleeSoldier {
	...
	static
	{
		...
		STATIC_ATTRIBUTES.setFullHealth( 1200 );
		STATIC_ATTRIBUTES.setHealth( 1200 ); STATIC_ATTRIBUTES.setdHealthAge( 0 ); STATIC_ATTRIBUTES.setdHealthLvl( 30 );
		...
		STATIC_ATTRIBUTES.setSpeed(.65f * dp);
	}
	...
	public ExoticRings(@NonNull vector loc, Teams team){
		super(team);
		setLoc(loc);
		setTeam(team);
	}
