...
public class StatueCross extends Building {
	...
	static{
		STATIC_ATTRIBUTES = new Attributes(); STATIC_ATTRIBUTES.setRequiresAge(Age.STONE);  STATIC_ATTRIBUTES.setRequiresTcLvl(13);
	...
	public StatueCross(@NonNull vector v, Teams t)
	{
		super(name );
