...
public class Snowman extends Building {
	...
	static{
		STATIC_ATTRIBUTES = new Attributes(); STATIC_ATTRIBUTES.setRequiresAge(Age.STONE);  STATIC_ATTRIBUTES.setRequiresTcLvl(18);

		STATIC_ATTRIBUTES.setLevel( 1 );
		STATIC_ATTRIBUTES.setFullHealth(10000);
		STATIC_ATTRIBUTES.setHealth(10000);
