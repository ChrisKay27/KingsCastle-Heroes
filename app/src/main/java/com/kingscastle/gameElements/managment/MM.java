...
import com.kingscastle.effects.RisingTextManager;
import com.kingscastle.effects.ShouldDrawAnimCalcer;
import com.kingscastle.framework.DontUseThisMethodException;
...
import com.kingscastle.gameElements.MapBorderObject;
...
import com.kingscastle.teams.HumanTeam;
...
public class MM
{
	...
	public Player getPlayer( Teams team )
	{
		...
		throw new IllegalArgumentException("Player for this team has not been added!");
	}
