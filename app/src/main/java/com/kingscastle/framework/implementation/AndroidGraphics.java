...
public class AndroidGraphics implements Graphics
{
	...
	public AndroidGraphics( @NotNull Canvas canvas )
	{
		this.canvas = canvas;
	...
	@Override
	public void drawCircle(@NotNull vector v, float radius) {
		drawImage(rangeCircle, v.x, v.y, radius, radius);
	}
    @Override
    public void drawCircle(float x, float y, float radius) {
        drawImage(rangeCircle, x, y, radius, radius);
    }
	...
	@Override
	public void drawRoundRect( @NotNull RectF rect , int color )
	{
		paint.setColor(color);
	...
	@Override
	public void drawRoundRectBorder( @NotNull RectF rect , int color , float borderWidth)
	{
		paint.setColor(color);
	...
	@Override
	public void drawRectBorder( @NotNull RectF r , int color , float borderWidth )
	{
		paint.setColor( color );
		paint.setStrokeWidth( borderWidth );
		paint.setStyle(Style.STROKE);
	...
	@Override
	public void drawRectBorder( @NotNull RectF rect , @NotNull vector offset , int color , float borderWidth )
	{
		paint.setColor( color );
		paint.setStrokeWidth( borderWidth );
		paint.setStyle( Style.STROKE );
	...
	@Override
	public void drawRect( @NotNull RectF r , @NotNull vector offset , int color )
	{
		paint.setColor( color );
		paint.setStyle( Style.FILL );
	...
	@Override
	public void drawTextLabel( @NotNull TextLabel tl )
	{
		if( tl.isVisible() ){
	...
	@Override
	public void drawTextLabel( @NotNull TextLabel tl , float xoffs , float yoffs)
	{
		if( tl.isVisible() )
	...
	@Override
	public void drawImage( @NotNull Image image , int srcLeft , int srcTop ,
	...
	@Override
	public void drawImage( @NotNull Image image , int x , int y , int srcX , int srcY ,	int srcWidth , int srcHeight )	{
	...
	@Override
	public void drawImage( @NotNull Image image , float x , float y )	{
	...
	@Override
	public void drawImage( @NotNull Image image, float x, float y, Paint paint )
	{
		if( image == null )
		{
			return;
	...
	@Override
	public void drawImageLabel(@NotNull ImageLabel il)	{
		drawImageLabel( il , 0 , 0 );
	}

	@Override
	public void drawImageLabel(@NotNull ImageLabel il , float xoffs , float yoffs )
	{
	...
	void drawScaledImage(@NotNull Image image, int x, int y, int width,
	...
	@Override
	public void drawImageOnWholeScreen ( @NotNull Image image )	{
	...
	@Override
	public void setBitmap( @NotNull Bitmap framebuff)
	{
