...
public class UndeadSkeletonWarrior extends BasicMeleeSoldier
{
	...
	static
	{
		...
		STATIC_ATTRIBUTES.setArmor( 2 );  STATIC_ATTRIBUTES.setdArmorAge( 3 ); STATIC_ATTRIBUTES.setdArmorLvl( 1 );
	...
	public UndeadSkeletonWarrior( @NonNull vector loc , Teams team )
	{
		super(team);
		setLoc( loc );
	}
