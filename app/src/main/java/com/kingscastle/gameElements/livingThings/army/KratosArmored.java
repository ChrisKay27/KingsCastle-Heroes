...
public class KratosArmored extends MeleeSoldier
{
	...
	static
	{
		...
		STATIC_ATTRIBUTES.setHealth( 600 ); STATIC_ATTRIBUTES.setdHealthAge( 0 ); STATIC_ATTRIBUTES.setdHealthLvl( 10 ); //
		STATIC_ATTRIBUTES.setFullMana( 0 );
		STATIC_ATTRIBUTES.setMana( 0 );
		STATIC_ATTRIBUTES.setHpRegenAmount( 1 );
		STATIC_ATTRIBUTES.setRegenRate( 1000 );
		STATIC_ATTRIBUTES.setArmor( 12 );  STATIC_ATTRIBUTES.setdArmorAge( 3 ); STATIC_ATTRIBUTES.setdArmorLvl( 1 );
	...
	public KratosArmored(@NonNull vector loc, Teams team)
	{
		super(team);
		setLoc( loc );
		super.team = team;
