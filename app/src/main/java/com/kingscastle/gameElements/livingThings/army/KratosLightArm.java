...
public class KratosLightArm extends MeleeSoldier
{
	...
	static
	{
		...
		STATIC_ATTRIBUTES.setFullHealth( 30 );
		STATIC_ATTRIBUTES.setHealth( 30 ); STATIC_ATTRIBUTES.setdHealthAge( 0 ); STATIC_ATTRIBUTES.setdHealthLvl( 10 ); //
	...
	public KratosLightArm(@NonNull vector loc, Teams team)
	{
		super(team);
		setLoc( loc );
		super.team = team;
