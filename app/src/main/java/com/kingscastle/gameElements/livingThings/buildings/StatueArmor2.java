...
public class StatueArmor2 extends Building {
	...
	static{
		STATIC_ATTRIBUTES = new Attributes(); STATIC_ATTRIBUTES.setRequiresAge(Age.STONE);  STATIC_ATTRIBUTES.setRequiresTcLvl(11);
	...
	public StatueArmor2(@NonNull vector v, Teams t)
	{
		super(name );
