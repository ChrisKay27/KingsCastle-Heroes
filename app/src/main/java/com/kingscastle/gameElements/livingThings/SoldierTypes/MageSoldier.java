...
import com.kingscastle.gameElements.livingThings.attacks.Attack;
...
//					}
				...
				@NotNull
                @Override
				public CondRespon wouldWorkButSecondChoice(@NotNull LivingThing lt)
				{
					if( lt.getAQ() == null )
						return CondRespon.TRUE;
