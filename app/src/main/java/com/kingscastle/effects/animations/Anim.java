...
public class Anim
{
	...
	@NotNull
	protected final List<Anim> addedInFront = new ArrayList<>(), addedBehind = new ArrayList<>();
    ...
    private vector locToCopy;

	@NotNull
    final vector offs = new vector();
    ...
    public Anim(@NotNull vector loc) {
        this.loc = loc;
    }
	...
	public boolean act()
	{
        vector locToCopy_local = locToCopy;
        if( locToCopy_local != null )
            loc.set(locToCopy_local);
