...
public final class ChangeStance extends Order {
	...
	private final ArrayList<Humanoid> soldiers = new ArrayList<Humanoid>();
	...
	@Override
	public void setHumanoidsToBeOrdered(List<? extends Humanoid> soldiers )
	{
	...
	@Override
	public void setHumanoidToBeOrdered( Humanoid unit )
	{
	if ( !(unit instanceof Humanoid) )
		{
			return ;
		}
		else
	...
	public boolean analyseTouchEvent( TouchEvent event , CoordConverter cc, CD cd)
	{
		...
		//		HumanoidOptions uo = HumanoidOptions.get();
	...
	void switchEveryonesStance(List<Humanoid> soldiers)
	{
		currStance = currStance.getNext();
		for( Humanoid unit : soldiers )
