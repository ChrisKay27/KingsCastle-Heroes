...
public class ViewAnimatorHelper {
    ...
    public static void shinkAway( final View v, int shrinkTime,  Animator.AnimatorListener listener ){
    ...
    public static void grow( final View v, int growTime,  Animator.AnimatorListener listener  ){
    ...
    public static void slideToBottomOfScreen( final View v, int screenHeight, int slideTime,  Animator.AnimatorListener listener  ){
